    ...
    namespace QuantLib
    {
            ...
            callable_(true) 
        {
            ...
            if (!rebate_.empty()) 
            {
                ...
                QL_REQUIRE(underlying_->alreadyDeflated() == rebate_->alreadyDeflated(), "incompatible deflations");
            } 
            else
            {
        ...
        std::vector<Size>
            CallSpecifiedPathwiseMultiProduct::suggestedNumeraires() const 
        {
        ...
        std::vector<Time>
            CallSpecifiedPathwiseMultiProduct::possibleCashFlowTimes() const 
        {
        ...
        Size
            CallSpecifiedPathwiseMultiProduct::maxNumberOfCashFlowsPerProductPerStep() const 
        {
        ...
        const MarketModelPathwiseMultiProduct&
            CallSpecifiedPathwiseMultiProduct::underlying() const 
        {
            return *underlying_;
        }

        const ExerciseStrategy<CurveState>&
            CallSpecifiedPathwiseMultiProduct::strategy() const 
        {
            return *strategy_;
        }

        const MarketModelPathwiseMultiProduct&
            CallSpecifiedPathwiseMultiProduct::rebate() const 
        {
            return *rebate_;
        }

        void CallSpecifiedPathwiseMultiProduct::enableCallability() 
        {
            callable_ = true;
        }

        void CallSpecifiedPathwiseMultiProduct::disableCallability() 
        {
            callable_ = false;
        }
